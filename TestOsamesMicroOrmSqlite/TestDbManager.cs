    ...
    public class SqliteTestDbManager : OsamesMicroOrmSqliteTest
    {
        ...
        public void TestInsertUsingSqlite()
        {
            ...
            try
            {
                ...
                byte affectedRecordsCount = DbManager.Instance.ExecuteNonQuery(_transaction, CommandType.Text, "INSERT INTO Customer (LastName, FirstName, Email) VALUES (@lastname, @firstname, @email)", parameters.ToArray(), out lastInsertedRowId);
